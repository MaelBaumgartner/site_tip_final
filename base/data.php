<?php
	...
	$data[0]['reponses'][2]['enonce'] = "Vous demandez à votre petite-fille de payer";
	$data[0]['reponses'][2]['juste'] = false;
	
	$data[1]['question'] = "Le cadenat dans l'url (Lien dans la barre de recherche) signifie :";
	$data[1]['reponses'][0]['enonce'] = "Que le site est sécurisé";
	$data[1]['reponses'][0]['juste'] = true;
	$data[1]['reponses'][1]['enonce'] = "Que le site n'est pas sécurisé";
	$data[1]['reponses'][1]['juste'] = false;
	$data[1]['reponses'][2]['enonce'] = "Que le site est privé";
	$data[1]['reponses'][2]['juste'] = false;
	
	$data[2]['question'] = "Est-il conseillé d'utiliser un mot de passe différent pour chaque site internet ?";
	$data[2]['reponses'][0]['enonce'] = "Non";
	$data[2]['reponses'][0]['juste'] = false;
	$data[2]['reponses'][1]['enonce'] = "Oui";
	$data[2]['reponses'][1]['juste'] = true;
	
	$data[3]['question'] = "Un anti-virus informatique sert à ?";
	$data[3]['reponses'][0]['enonce'] = "A réparer un ordinateur";
	$data[3]['reponses'][0]['juste'] = false;
	$data[3]['reponses'][1]['enonce'] = "Eviter les virus informatiques";
	$data[3]['reponses'][1]['juste'] = true;
	$data[3]['reponses'][2]['enonce'] = "À faire croire que l'ordinateur est connecté à un autre endroit de là où il est connecté normalement";
	$data[3]['reponses'][2]['juste'] = false;
	
	
	$data[4]['question'] = "Une arnaque de type phishing c'est ?";
	$data[4]['reponses'][0]['enonce'] = "Une publicité gentiment mensongère";
	$data[4]['reponses'][0]['juste'] = false;
	...
	$data[6]['reponses'][0]['enonce'] = "Oui";
	$data[6]['reponses'][0]['juste'] = true;
	...
	$data[7]['reponses'][1]['juste'] = false;
	
	$data[8]['question'] = "Quel est parmis ces propositions, le meilleur moyen de protéger ses données contre le vol de données ?";
	$data[8]['reponses'][0]['enonce'] = "Uniquement entrer les données personnelles sur les sites de confiance, vérifier si l'adresse email d'un potentiel mail dangereux est bizarre, avoir un mot-de-passe différent pour chaque site";
